...
const data = [
    { month: "Aug", activity: 1400 }, // August
    { month: "Sep", activity: 800 },  // September
    { month: "Oct", activity: 950 },  // October
    { month: "Nov", activity: 1100 }, // November
    { month: "Dec", activity: 1600 }, // December
    { month: "Jan", activity: 600 }   // January
];

const DelhiSubscriptionPage = () => {
  return (
    <div className="subscription-page-container">
      ...
      <div className="subscription-page-header">
        ...
        <div className="subscription-header-right">
          <h1>delhimedicalcouncil.org</h1>
          <a href="https://delhimedicalcouncil.org" target="_blank" rel="noopener noreferrer">
            Visit Site
          </a>
        </div>
      </div>
      ...
      <div className="subscription-page-info">
        ...
        <ul>
          ...
          <li>Disk Space: 520.6 MB</li>
          <li>Traffic This Month: 15,672.1 MB</li>
        </ul>
      </div>
...
export default DelhiSubscriptionPage;
